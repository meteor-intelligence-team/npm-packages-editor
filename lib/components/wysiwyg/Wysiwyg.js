...
var colors = exports.colors = [{ label: 'Red', style: 'RED', icon: "ui red stop icon" }, { label: 'Orange', style: 'ORANGE', icon: "ui orange stop icon" }, { label: 'Yellow', style: 'YELLOW', icon: "ui yellow stop icon" }, { label: 'Green', style: 'GREEN', icon: "ui green stop icon" }, { label: 'Blue', style: 'BLUE', icon: "ui blue stop icon" }, { label: 'Grey', style: 'GREY', icon: "ui grey stop icon" }];
...
var BLOCK_TYPES = [
//{label: 'H1', style: 'header-one', icon:"header icon"},
//{label: 'H2', style: 'header-two', icon:"header icon"},
//{label: 'H3', style: 'header-three', icon:"header icon"},
{ label: 'H4', style: 'header-four', icon: "header icon" },
//{label: 'H5', style: 'header-five', icon:"header icon"},
//{label: 'H6', style: 'header-six', icon:"header icon"},
{ label: 'Blockquote', style: 'blockquote', icon: "ui left quote icon" }, { label: 'UL', style: 'unordered-list-item', icon: "ui unordered list icon" }, { label: 'OL', style: 'ordered-list-item', icon: "ui ordered list icon" }];
...
var INLINE_STYLES = [{ label: 'Bold', style: 'BOLD', icon: "ui bold icon" }, { label: 'Italic', style: 'ITALIC', icon: "ui italic icon" }, { label: 'Underline', style: 'UNDERLINE', icon: "ui underline icon" }];
